...
The backend never reads the csv file directly. Instead the player data lives in the
...
DB_NAME = os.environ.get("POSTGRES_DB", "promatch")
DB_USER = os.environ.get("POSTGRES_USER", "promatch")
